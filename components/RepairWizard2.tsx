      ...
      {step === 5 && (
        <div className="min-h-screen flex items-center justify-center bg-[#f9f9f9] px-4 py-10">
          <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-xl text-center">
            ...
            <a
              href="https://www.google.com/maps/place/Alpha+Fix+%7C+15+Minutes+Repair/@29.579852,-95.76646,1230m/data=!3m1!1e3!4m6!3m5!1s0x86411f7faf0dd083:0xcad9aaf3956bf8a4!8m2!3d29.5798519!4d-95.7664605!16s%2Fg%2F11spc720sd!5m1!1e1?hl=en&entry=ttu&g_ep=EgoyMDI1MDUxMy4xIKXMDSoASAFQAw%3D%3D"
              target="_blank"
